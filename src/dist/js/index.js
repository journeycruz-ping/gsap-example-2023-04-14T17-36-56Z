...
var _CSSRulePlugin = require("gsap/dist/CSSRulePlugin");
var _DrawSVGPlugin = require("gsap/dist/DrawSVGPlugin");
var _MotionPathPlugin = require("gsap/dist/MotionPathPlugin");
_gsap["default"].registerPlugin(_ScrollTrigger.ScrollTrigger, _CSSRulePlugin.CSSRulePlugin, _DrawSVGPlugin.DrawSVGPlugin, _MotionPathPlugin.MotionPathPlugin);
_gsap["default"].set([".container", ".line-svg"], {
  autoAlpha: 1 // same as opacity: 1; visibility: visible; css properties
});

_gsap["default"].set([
// set() same as to() with duration: 0
"#cc-shade-outside", "#cc-shade-inside", "#heart-fill-1", "#heart-fill-2", "#heart-fill-3", "#heart-fill-4", ".logo", "h1", "para"], {
  autoAlpha: 0 // opacity: 0; visibility: hidden
});

var linesBase = _gsap["default"].utils.toArray("#base path");
var linesRunning = _gsap["default"].utils.toArray("#running path");
var texts = [".text-1", ".text-3", ".text-4", ".text-5"];
_gsap["default"].set([linesBase, linesRunning], {
  drawSVG: "0% 0%" // starting point
});

// fade in animation
_gsap["default"].set([".logo", "h1", ".para"], {
  y: 50
});
_gsap["default"].to([".logo", "h1", ".para"], {
  autoAlpha: 1,
  y: 0,
  stagger: 0.1,
  duration: 1
...
var draw = function draw(el) {
  ...
  tl.to(el, {
    ...
    drawSVG: "50% 100%",
    // draw the running line from 50% to the end
    duration: 0.5
  }, "<").to(".line-circle", {
    duration: 0.5,
    motionPath: {
...
_ScrollTrigger.ScrollTrigger.create({
  ...
  start: function start() {
    return "top+=10% center";
  },
  // start at top of page
  end: "bottom 50%",
  // keep it centered (vertica) on scroll
  fastScrollEnd: true,
...
_ScrollTrigger.ScrollTrigger.create({
  ...
  fastScrollEnd: true,
  animation: _gsap["default"].to(["#cc-shade-outside", "#cc-shade-inside"], {
    autoAlpha: 1,
    stagger: 0.01,
    duration: 1
  })
...
_ScrollTrigger.ScrollTrigger.create({
  ...
  fastScrollEnd: true,
  animation: _gsap["default"].to(["#heart-fill-1", "#heart-fill-2", "#heart-fill-3"], {
    autoAlpha: 1,
    stagger: 0.01,
    duration: 1
  })
...
_ScrollTrigger.ScrollTrigger.create({
  ...
  onEnter: function onEnter() {
    return _gsap["default"].to("#heart-fill-4", {
      autoAlpha: 1,
      duration: 1
    });
  },
...
texts.forEach(function (pingroup) {
  _ScrollTrigger.ScrollTrigger.create({
    trigger: pingroup,
    start: "center center",
    end: "+=".concat(window.innerHeight / 2),
    pin: true
  });
});
...
texts.forEach(function (e) {
  _ScrollTrigger.ScrollTrigger.create({
    ...
    onEnter: function onEnter() {
      return _gsap["default"].to(e, enterConfig);
    },
    onEnterBack: function onEnterBack() {
      return _gsap["default"].to(e, enterConfig);
    },
    onLeave: function onLeave() {
      return _gsap["default"].to(e, {
        y: -100,
        opacity: 0,
        duration: 0.4
      });
...
},{"@babel/runtime/helpers/interopRequireDefault":1,"gsap":6,"gsap/dist/CSSRulePlugin":2,"gsap/dist/DrawSVGPlugin":3,"gsap/dist/MotionPathPlugin":4,"gsap/dist/ScrollTrigger":5}]},{},[7]);
